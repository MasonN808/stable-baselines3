...
from stable_baselines3.sac_critical_point.policies import Actor, CnnPolicy, MlpPolicy, MultiInputPolicy, SACPolicy

SelfSAC_Critical_Point = TypeVar("SelfSAC_Critical_Point", bound="SAC_Critical_Point")


class SAC_Critical_Point(OffPolicyAlgorithm):
    """
