...
SelfPPO_Penalty = TypeVar("SelfPPO_Penalty", bound="PPO_Penalty")


class PPO_Penalty(OnPolicyAlgorithm):
    """
    Proximal Policy Optimization algorithm (PPO) (penalty version)
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.dynamic_beta and self.target_kl is not None:
